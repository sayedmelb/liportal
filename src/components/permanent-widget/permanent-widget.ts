...
@Component({
  selector: 'permanent-widget',
  templateUrl: 'permanent-widget.html'
})
export class PermanentWidget extends InputControlWidget implements OnDestroy {
  ...
  setdefault() {
    ...
    if (this.dynamicdata.hasOwnProperty("PermBWIsSubmitted")) {
      this.dynamicdata.PermBWIsSubmitted = null;
      delete this.dynamicdata['PermBWIsSubmitted'];
    }
