...
@Component({
  selector: "flex-rules-down",
  templateUrl: "flex-rules-down.html"
})

export class FlexRulesDown {
  ...
  flexDown: string = "balanceddown";
  flexupUtilisationDown: number = 80;
  flexupUtilisationMinutesDown: number = 5;
...
console.log("flex rules", this.schema);
...
this.initialRange = {
  ...
  mapToModel(){
    ...
    {
      if(this.model[0].service[0].properties.decreased_utilisation_mode)
      this.flexUp =this.model[0].service[0].properties.decreased_utilisation_mode;
      this.flexUp = this.flexUp.toLowerCase();
      if(this.flexUp.toLowerCase() == "quickly" || this.flexUp.toLowerCase() == "aggresive" )
      this.flexUp = "aggresive";
      this.flexUp =  this.flexUp + "down";
      ...
      if(this.model[0].service[0].properties.utilisation_decrease_threshold_pc)
      this.flexupUtilisationDown = this.model[0].service[0].properties.utilisation_decrease_threshold_pc;
      
      if(this.model[0].service[0].properties.decreased_utilisation_monitor_time_period)
      this.flexupUtilisationMinutesDown = this.model[0].service[0].properties.decreased_utilisation_monitor_time_period /60;
...
addToModel(){
  if(this.model) {
    delete this.model[0]["utilisation_decrease_threshold_pc"];
    this.model[0]["utilisation_decrease_threshold_pc"] = this.flexupUtilisationDown;
    delete this.model[0]["decreased_utilisation_mode"];
    this.model[0]["decreased_utilisation_mode"] = this.flexDown;

    delete this.model[0]["decreased_utilisation_monitor_time_period"];
    this.model[0]["decreased_utilisation_monitor_time_period"] = this.flexupUtilisationMinutesDown;
