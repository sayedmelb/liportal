evaluate = function (){
    ...
    template = "<ion-row > <ion-col col-12> <span class='sub-heading'> Contracted Speed </span>&nbsp;<info-icon></info-icon></ion-col> <ion-col col-12> <p class='description-text'>Use the slider to set the service speed you require between A-End and B-End.<br><b>Note:</b> The slider below represents <b>A-end</b> which is currently utilised link</p> </ion-col> </ion-row>";
