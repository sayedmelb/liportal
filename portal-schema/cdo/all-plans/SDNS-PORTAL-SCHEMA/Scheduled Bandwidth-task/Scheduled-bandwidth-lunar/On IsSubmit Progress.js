...
evaluate = function (){
    console.log("submit PC confirm TRACK Progress =>", model, getDataSource('review'));
    let _ = getLodash();
    let dataSource = getDataSource('review');
    console.log("datasource TRACK Progress", dataSource);
   ...
   //    });
   (result) => {
       console.log("Result SBW TRACKSUBMIT =>", result);
      ...
      // result.selectedProduct = product;
       ...
       console.log("result track SBW", result ); 
